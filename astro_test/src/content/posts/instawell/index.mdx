...
description: "An open-source Python package that automates thermal shift assay analysis — born from watching a collaborator spend an afternoon manually copying plate reader data into Excel. Available on PyPI."
cover: ./instawell_cover.jpg
---
...
<table>
  ...
  <tbody>
    <tr>
      ...
      <td>0um|DMSO|NPC|PBS</td>
      <td>1.5um|DrugX|ProteinA|PBS</td>
      <td>6um|DrugX|ProteinA|PBS</td>
    </tr>
  </tbody>
</table>
