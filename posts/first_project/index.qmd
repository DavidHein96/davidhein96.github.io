...
I also did not use git for this project. Version control wasn't really on my radar yet. Recreating it here for the blog was partly an exercise in doing things more properly the second time around.

Here's a link to the [abstract.](https://pubmed.ncbi.nlm.nih.gov/33710137/)

## Project Setup

This blog was created with Quarto in R Studio, so to include Python versions of analysis and graphics I needed to specify an Anaconda environment in the setup chunk.
