...
description: "Building LLM pipelines to extract structured data from 3,000+ kidney cancer pathology reports. The real finding wasn't the F1 scores — it was that success depends almost entirely on precisely defining what you actually want to extract, and why."
cover: ./llm_npj.jpg
---

import Figure from '../../../components/Figure.astro';
import errorTypes from './error_types.png';
...
<Figure src={errorTypes} alt="The 13 discrete error subcategories identified during iterative pipeline refinement." width="66%" caption="The 13 discrete error subcategories identified during iterative pipeline refinement." />
...
The pipeline is available as an open-source repo with a docs site: [**prompts_to_table**](https://davidhein96.github.io/prompts_to_table/). The technical implementation details are there if you need them — prompt templates, output validation, orchestration. The harder part, documented in the paper, is the process that got the prompts to where they ended up.
