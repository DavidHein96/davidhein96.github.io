...
description: "GSVA and mROAST workflows examining how genetic ancestry correlates with tumor molecular subtypes in colorectal cancer. Used PCA as a diagnostic for MNAR tumor grade missingness. Co-first author paper in Genome Medicine."
cover: ./dalle_chromosome.jpg
---
...
# For each gene set, create a logical vector
...
multinom_cms_discrete <- multinom(
  prediction ~ genetic_ancestry_group + early_onset,
...
![Expected vs. observed CMS subtype distributions by imputed racial/ethnic category. Panel area is proportional to patient counts; findings with absolute standardized residuals greater than 1.96 are marked with an asterisk.](./cms.png)
...
Rhead B\*, **Hein D**\*, Pouliot Y, Guinney J, De La Vega FM, Sanford NN. Association of genetic ancestry with molecular tumor profiles in colorectal cancer. *Genome Medicine*. 16, 99 (2024). [https://doi.org/10.1186/s13073-024-01373-w](https://doi.org/10.1186/s13073-024-01373-w) (\*co-first author)
